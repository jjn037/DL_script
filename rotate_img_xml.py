...
img_path = "/Users/didi/Desktop/temp/"
_xml_path = "/Users/didi/Desktop/business_licence_anno1/"
new_img_path = "/Users/didi/Desktop/temp/"
new_xml_path = "/Users/didi/Desktop/xmls/"
...
for angle in (30, 60, 90, 120, 150, 180, 210, 240, 270, 300, 330):
    ...
    for i in os.listdir(img_path):
        ...
        #     # 写入图像
        #     cv2.imwrite(new_img_path + a + "_" + str(angle) +"d.jpg", rotated_img)
        #     print "log: [%sd] %s is processed." % (angle, i)
        # else:
        xml_path = os.path.join(_xml_path, a + ".xml")
        _img_path = img_path + i
        print _img_path
        src = cv2.imread(_img_path)
        rotated_img = rotate_image(src, angle)
        # 写入图像
        cv2.imwrite(new_img_path + a + "_" + str(angle) +"d.jpg", rotated_img)
        ...
        #     box.set('updated', 'yes')
        # # 写入新的xml
        # tree.write(new_xml_path + a + "_" + str(angle) +".xml")
