...
xmlpath = '/nfs/project/jiangjianan/tf-faster-rcnn-master/data/license/Annotations/'          #源图像路径
imgpath = '/nfs/project/jiangjianan/tf-faster-rcnn-master/data/license/JPEGImages/'         #源图像所对应的xml文件路径
rotated_imgpath = '/nfs/project/jiangjianan/tf-faster-rcnn-master/data/license/JPEGImages/rotate/'
rotated_xmlpath = '/nfs/project/jiangjianan/tf-faster-rcnn-master/data/license/Annotations/rotate/'
angles = (30, 60, 90, 120, 150, 180, 210, 240, 270,  300, 330)
rotate_imgs = "/nfs/project/jiangjianan/OCR/dataset/license/ImageSets/test.txt"
